<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:a="http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2" version="1.1">
...
<xsl:when test="$TD='TD16'"> (integrazione fattura reverse charge interno) </xsl:when>
<xsl:when test="$TD='TD17'"> (integrazione/autofattura per acquisto servizi da estero) </xsl:when>
<xsl:when test="$TD='TD18'"> (integrazione per acquisto beni intracomunitari) </xsl:when>
<xsl:when test="$TD='TD19'"> (integrazione/autofattura per acquisto beni ex art.17 c.2 DPR 633/72) </xsl:when>
<xsl:when test="$TD='TD20'"> (autofattura per regolarizzazione e integrazione delle fatture - art.6 c.8 d.lgs.471/97 o art.46 c.5 D.L.331/93) </xsl:when>
<xsl:when test="$TD='TD21'"> (autofattura per splafonamento) </xsl:when>
<xsl:when test="$TD='TD22'"> (estrazione beni da Deposito IVA) </xsl:when>
<xsl:when test="$TD='TD23'"> (estrazione beni da Deposito IVA con versamento IVA) </xsl:when>
<xsl:when test="$TD='TD24'"> (fattura differita - art.21 c.4 terzo periodo lett. a - DPR 633/72) </xsl:when>
<xsl:when test="$TD='TD25'"> (fattura differita - art.21 c.4 terzo periodo lett. b - DPR 633/72) </xsl:when>
<xsl:when test="$TD='TD26'"> (cessione di beni ammortizzabili e per passaggi interni - art.36 DPR 633/72) </xsl:when>
<xsl:when test="$TD='TD27'"> (fattura per autoconsumo o per cessioni gratuite senza rivalsa) </xsl:when>
...
<xsl:if test="$CP!=''"> (decodifica come da modello CU) </xsl:if>
</li>
</xsl:if>
</ul>
</xsl:for-each>
...
<xsl:when test="$NT='N2.1'"> (non soggette ad IVA - artt. da 7 a 7-septies del DPR 633/72) </xsl:when>
<xsl:when test="$NT='N2.2'"> (non soggette - altri casi) </xsl:when>
<xsl:when test="$NT='N3'"> (non imponibili) </xsl:when>
<xsl:when test="$NT='N3.1'"> (non imponibili - esportazioni) </xsl:when>
<xsl:when test="$NT='N3.2'"> (non imponibili - cessioni intracomunitarie) </xsl:when>
<xsl:when test="$NT='N3.3'"> (non imponibili - cessioni verso S.Marino) </xsl:when>
<xsl:when test="$NT='N3.4'"> (non imponibili - operazioni assimilate alle cessioni all'esportazione) </xsl:when>
<xsl:when test="$NT='N3.5'"> (non imponibili - a seguito di dichiarazioni d'intento) </xsl:when>
<xsl:when test="$NT='N3.6'"> (non imponibili - altre operazioni che non concorrono alla formazione del plafond) </xsl:when>
<xsl:when test="$NT='N4'"> (esenti) </xsl:when>
<xsl:when test="$NT='N5'"> (regime del margine / IVA non esposta in fattura) </xsl:when>
<xsl:when test="$NT='N6'"> (inversione contabile per le operazioni in reverse charge ovvero nei casi di autofatturazione per acquisti extra UE di servizi ovvero per importazioni di beni nei soli casi previsti) </xsl:when>
<xsl:when test="$NT='N6.1'"> (inversione contabile - cessione di rottami e altri materiali di recupero) </xsl:when>
<xsl:when test="$NT='N6.2'"> (inversione contabile - cessione di oro e argento ai sensi della legge 7/2000 nonché di oreficeria usata ad OPO) </xsl:when>
<xsl:when test="$NT='N6.3'"> (inversione contabile - subappalto nel settore edile) </xsl:when>
<xsl:when test="$NT='N6.4'"> (inversione contabile - cessione di fabbricati) </xsl:when>
<xsl:when test="$NT='N6.5'"> (inversione contabile - cessione di telefoni cellulari) </xsl:when>
<xsl:when test="$NT='N6.6'"> (inversione contabile - cessione di prodotti elettronici) </xsl:when>
<xsl:when test="$NT='N6.7'"> (inversione contabile - prestazioni comparto edile e settori connessi) </xsl:when>
<xsl:when test="$NT='N6.8'"> (inversione contabile - operazioni settore energetico) </xsl:when>
<xsl:when test="$NT='N6.9'"> (inversione contabile - altri casi) </xsl:when>
<xsl:when test="$NT='N7'"> (IVA assolta in altro stato UE - vendite a distanza ex art.40 c.3 e 4 e art.41 c.1 lett. b DL 331/93; prestazione di servizi di telecomunicazioni, tele-radiodiffusione ed elettronici ex art.7-sexies lett. f, g, e art.74-sexies DPR 633/72) </xsl:when>
...
<xsl:when test="$NAT='N2.1'"> (non soggette ad IVA - artt. da 7 a 7-septies del DPR 633/72) </xsl:when>
<xsl:when test="$NAT='N2.2'"> (non soggette - altri casi) </xsl:when>
<xsl:when test="$NAT='N3'"> (non imponibili) </xsl:when>
<xsl:when test="$NAT='N3.1'"> (non imponibili - esportazioni) </xsl:when>
<xsl:when test="$NAT='N3.2'"> (non imponibili - cessioni intracomunitarie) </xsl:when>
<xsl:when test="$NAT='N3.3'"> (non imponibili - cessioni verso S.Marino) </xsl:when>
<xsl:when test="$NAT='N3.4'"> (non imponibili - operazioni assimilate alle cessioni all'esportazione) </xsl:when>
<xsl:when test="$NAT='N3.5'"> (non imponibili - a seguito di dichiarazioni d'intento) </xsl:when>
<xsl:when test="$NAT='N3.6'"> (non imponibili - altre operazioni che non concorrono alla formazione del plafond) </xsl:when>
<xsl:when test="$NAT='N4'"> (esenti) </xsl:when>
<xsl:when test="$NAT='N5'"> (regime del margine / IVA non esposta in fattura) </xsl:when>
<xsl:when test="$NAT='N6'"> (inversione contabile per le operazioni in reverse charge ovvero nei casi di autofatturazione per acquisti extra UE di servizi ovvero per importazioni di beni nei soli casi previsti) </xsl:when>
<xsl:when test="$NAT='N6.1'"> (inversione contabile - cessione di rottami e altri materiali di recupero) </xsl:when>
<xsl:when test="$NAT='N6.2'"> (inversione contabile - cessione di oro e argento ai sensi della legge 7/2000 nonché di oreficeria usata ad OPO) </xsl:when>
<xsl:when test="$NAT='N6.3'"> (inversione contabile - subappalto nel settore edile) </xsl:when>
<xsl:when test="$NAT='N6.4'"> (inversione contabile - cessione di fabbricati) </xsl:when>
<xsl:when test="$NAT='N6.5'"> (inversione contabile - cessione di telefoni cellulari) </xsl:when>
<xsl:when test="$NAT='N6.6'"> (inversione contabile - cessione di prodotti elettronici) </xsl:when>
<xsl:when test="$NAT='N6.7'"> (inversione contabile - prestazioni comparto edile e settori connessi) </xsl:when>
<xsl:when test="$NAT='N6.8'"> (inversione contabile - operazioni settore energetico) </xsl:when>
<xsl:when test="$NAT='N6.9'"> (inversione contabile - altri casi) </xsl:when>
<xsl:when test="$NAT='N7'"> (IVA assolta in altro stato UE - vendite a distanza ex art.40 c.3 e 4 e art.41 c.1 lett. b DL 331/93; prestazione di servizi di telecomunicazioni, tele-radiodiffusione ed elettronici ex art.7-sexies lett. f, g, e art.74-sexies DPR 633/72) </xsl:when>
<xsl:otherwise>
<span>(!!! codice non previsto !!!)</span>
</xsl:otherwise>
</xsl:choose>
...
<xsl:when test="$NAT1='N6'"> (inversione contabile per le operazioni in reverse charge ovvero nei casi di autofatturazione per acquisti extra UE di servizi ovvero per importazioni di beni nei soli casi previsti) </xsl:when>
<xsl:when test="$NAT1='N6.1'"> (inversione contabile - cessione di rottami e altri materiali di recupero) </xsl:when>
<xsl:when test="$NAT1='N6.2'"> (inversione contabile - cessione di oro e argento ai sensi della legge 7/2000 nonché di oreficeria usata ad OPO) </xsl:when>
<xsl:when test="$NAT1='N6.3'"> (inversione contabile - subappalto nel settore edile) </xsl:when>
<xsl:when test="$NAT1='N6.4'"> (inversione contabile - cessione di fabbricati) </xsl:when>
<xsl:when test="$NAT1='N6.5'"> (inversione contabile - cessione di telefoni cellulari) </xsl:when>
<xsl:when test="$NAT1='N6.6'"> (inversione contabile - cessione di prodotti elettronici) </xsl:when>
<xsl:when test="$NAT1='N6.7'"> (inversione contabile - prestazioni comparto edile e settori connessi) </xsl:when>
<xsl:when test="$NAT1='N6.8'"> (inversione contabile - operazioni settore energetico) </xsl:when>
<xsl:when test="$NAT1='N6.9'"> (inversione contabile - altri casi) </xsl:when>
<xsl:when test="$NAT1='N7'"> (IVA assolta in altro stato UE - vendite a distanza ex art.40 c.3 e 4 e art.41 c.1 lett. b DL 331/93; prestazione di servizi di telecomunicazioni, tele-radiodiffusione ed elettronici ex art.7-sexies lett. f, g, e art.74-sexies DPR 633/72) </xsl:when>
<xsl:otherwise>
<span>(!!! codice non previsto !!!)</span>
</xsl:otherwise>
</xsl:choose>
